...
pub fn durga() -> Raag {
    ...
    _aroha.push(Beat { swar: Some(Pitch::new("MA".to_string())), long: swars::BASE_SWAR_INTERVAL });
    ...
    _aroha.push(Beat { swar: Some(Pitch::new("SA+".to_string())), long: 2*swars::BASE_SWAR_INTERVAL });
    ...
    _avroha.push(Beat { swar: Some(Pitch::new("MA".to_string())), long: swars::BASE_SWAR_INTERVAL });
    ...
    _blk1.push(Beat { swar: Some(Pitch::new("MA".to_string())), long: swars::BASE_SWAR_INTERVAL });
    _blk1.push(Beat { swar: Some(Pitch::new("PA".to_string())), long: swars::BASE_SWAR_INTERVAL });
    _blk1.push(Beat { swar: Some(Pitch::new("DHA".to_string())), long: 2*swars::BASE_SWAR_INTERVAL });
    _pakad.push(SwarBlock(_blk1));

    let mut _blk2: Vec<Beat> = vec![];
    _blk2.push(Beat { swar: Some(Pitch::new("MA".to_string())), long: swars::BASE_SWAR_INTERVAL });
    _blk2.push(Beat { swar: Some(Pitch::new("RE".to_string())), long: 2*swars::BASE_SWAR_INTERVAL });
