...
pub fn bhupali<'a>() -> Raag<'a> {
    ...
    _aroha.push(Beat { swar: Some(Pitch::new("GA")), long: swars::BASE_SWAR_INTERVAL });
    ...
    _aroha.push(Beat { swar: Some(Pitch::new("SA+")), long: swars::BASE_SWAR_INTERVAL });
    ...
    _avroha.push(Beat { swar: Some(Pitch::new("GA")), long: swars::BASE_SWAR_INTERVAL });
    ...
    _blk1.push(Beat { swar: Some(Pitch::new("GA")), long: swars::BASE_SWAR_INTERVAL });
    _blk1.push(Beat { swar: Some(Pitch::new("RE")), long: swars::BASE_SWAR_INTERVAL });
    _blk1.push(Beat { swar: Some(Pitch::default()), long: swars::BASE_SWAR_INTERVAL });
    _blk1.push(Beat { swar: Some(Pitch::new("-DHA")), long: 3*swars::BASE_SWAR_INTERVAL });
    ...
    _blk2.push(Beat { swar: Some(Pitch::new("RE")), long: swars::BASE_SWAR_INTERVAL });
    _blk2.push(Beat { swar: Some(Pitch::new("GA")), long: 3*swars::BASE_SWAR_INTERVAL });
    _pakad.push(SwarBlock(_blk2));

    let mut _blk3: Vec<Beat> = vec![];
    _blk3.push(Beat { swar: Some(Pitch::new("PA")), long: swars::BASE_SWAR_INTERVAL });
    _blk3.push(Beat { swar: Some(Pitch::new("GA")), long: swars::BASE_SWAR_INTERVAL });
    _blk3.push(Beat { swar: Some(Pitch::new("DHA")), long: swars::BASE_SWAR_INTERVAL });
    _blk3.push(Beat { swar: Some(Pitch::new("PA")), long: 3*swars::BASE_SWAR_INTERVAL });
    _pakad.push(SwarBlock(_blk3));

    let mut _blk4: Vec<Beat> = vec![];
    _blk4.push(Beat { swar: Some(Pitch::new("GA")), long: swars::BASE_SWAR_INTERVAL });
    _blk4.push(Beat { swar: Some(Pitch::new("RE")), long: swars::BASE_SWAR_INTERVAL });
